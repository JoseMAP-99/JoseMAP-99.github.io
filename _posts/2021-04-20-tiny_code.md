...
| Estado inicial |
| - |
| ![](/images/tiny_code/cInicial.PNG "Fig. 2: Estado inicial de la aplicación") |
...
* **Tecla Espacio:** Reinicia la animación a su estado inicial.
...
{% include info.html text="Las tecla ESPACIO reinicia la animación"%}
{% include info.html text="Click para añadir un péndulo"%}

<div style="display: flex; justify-content: center">
  <iframe width="805" height="605" src="https://editor.p5js.org/JoseMAP-99/embed/_9tnGmAx3"></iframe>
</div>
