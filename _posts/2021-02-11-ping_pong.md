...
| <div class="display: flex; justify-content: center"> UI completa con Processing </div> | <div class="display: flex; justify-content: center"> UI reducida con P5.js </div> |
| - | - |
...
| - | - |
| El juego solicita el número de rondas para jugar | El juego puede comenzar directamente |
